...
def main():
    opt = {}
    opt['n_thread'] = 10            # Thread number
    opt['compression_level'] = 4    # for cv2.IMWRITE_PNG_COMPRESSION 0：max_size 9：min_size
...
def worker(path, opt):
    ...
    h_space = np.arange(0, h - crop_size + 1, step)         # Square clipping
